...
- **10-13 yrs** (impact ratio 0.0): largest decomposable qualified-pool gaps vs '5-9 yrs (JD target)': yoe_fit (+0.0222 weighted), assessment_score (+0.0208 weighted); career evidence (weight 0.30) dominates pedigree signals. The semantic component (0.25 weight) is not decomposable offline.
